...
from Functions.object_detection.metrics import io_utils
from Functions.object_detection.metrics import oid_challenge_evaluation_utils as utils
from Functions.object_detection.protos import string_int_label_map_pb2
